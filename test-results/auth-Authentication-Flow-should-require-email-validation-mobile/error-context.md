...
- Name: Authentication Flow >> should require email validation
- Location: C:\Users\shmes\Desktop\torch-group\e2e\auth.spec.ts:20:7
...
Call log:
  ...
  - waiting for locator('text=Email is required')
    ...
    at C:\Users\shmes\Desktop\torch-group\e2e\auth.spec.ts:25:58
```
