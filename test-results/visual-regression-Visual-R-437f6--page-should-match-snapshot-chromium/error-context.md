...
Previous: C:\Users\shmes\Desktop\torch-group\test-results\visual-regression-Visual-R-437f6--page-should-match-snapshot-chromium\services-previous.png
Received: C:\Users\shmes\Desktop\torch-group\test-results\visual-regression-Visual-R-437f6--page-should-match-snapshot-chromium\services-actual.png
    Diff: C:\Users\shmes\Desktop\torch-group\test-results\visual-regression-Visual-R-437f6--page-should-match-snapshot-chromium\services-diff.png
...
Call log:
  ...
  - waiting for fonts to load...
  - fonts loaded
  - Expected an image 1280px by 2791px, received 1280px by 720px. 2652141 pixels (ratio 0.75 of all image pixels) are different.
  - waiting 250ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 4039 pixels (ratio 0.01 of all image pixels) are different.
  - waiting 500ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - Expected an image 1280px by 720px, received 1280px by 2791px. 2660488 pixels (ratio 0.75 of all image pixels) are different.
