...
- Name: Performance Tests >> should optimize image loading
- Location: C:\Users\shmes\Desktop\torch-group\e2e\performance.spec.ts:57:7
...
Expected: not "lazy"
    at C:\Users\shmes\Desktop\torch-group\e2e\performance.spec.ts:68:29
```
...
- main:
  ...
  - heading "Welcome to Torch" [level=1]:
    ...
    - img
  - paragraph: Empowering businesses through | solutions and strategic partnerships.
