...
- Name: Visual Regression Tests >> mobile homepage should match snapshot
- Location: C:\Users\shmes\Desktop\torch-group\e2e\visual-regression.test.ts:49:7
...
Previous: C:\Users\shmes\Desktop\torch-group\test-results\visual-regression-Visual-R-2df70-epage-should-match-snapshot-chromium\homepage-mobile-previous.png
Received: C:\Users\shmes\Desktop\torch-group\test-results\visual-regression-Visual-R-2df70-epage-should-match-snapshot-chromium\homepage-mobile-actual.png
    Diff: C:\Users\shmes\Desktop\torch-group\test-results\visual-regression-Visual-R-2df70-epage-should-match-snapshot-chromium\homepage-mobile-diff.png

Call log:
  - expect.toHaveScreenshot(homepage-mobile.png) with timeout 5000ms
  ...
  - waiting for fonts to load...
  - fonts loaded
  - Expected an image 375px by 11211px, received 375px by 667px. 241641 pixels (ratio 0.06 of all image pixels) are different.
  - waiting 250ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 4805 pixels (ratio 0.02 of all image pixels) are different.
  - waiting 500ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 1663 pixels (ratio 0.01 of all image pixels) are different.
  ...
  - Timeout 5000ms exceeded.
    ...
    at C:\Users\shmes\Desktop\torch-group\e2e\visual-regression.test.ts:52:24
```
