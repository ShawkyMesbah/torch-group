$host_name = "aws-0-us-east-1.pooler.supabase.com"
$port = 5432

Write-Host "Testing connection to serverless pooler ($host_name) on port $port..."
...
# Try alternative regular Supabase host
$host_name = "db.ttzulxpncujgizidgwxk.supabase.co"
$port = 5432
Write-Host "`nTesting connection to $host_name on port $port..."
