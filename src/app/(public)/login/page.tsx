...
function LoginPageInner() {
  ...
  return (
    <div className="relative flex h-screen w-screen items-center justify-center bg-gradient-to-br from-black via-zinc-900 to-zinc-800 animate-fade-in-slow">
      ...
      <div className="z-10 mx-auto flex w-full flex-col justify-center sm:w-[370px]">
        ...
        <div className="rounded-2xl bg-black/70 shadow-xl shadow-black/40 px-8 py-10 backdrop-blur-md animate-fade-in">
          <div className="flex flex-col space-y-2 text-center mb-6">
            <h1 className="text-3xl font-bold tracking-tight text-white">Welcome back</h1>
            <p className="text-sm text-zinc-400">Enter your credentials to sign in to your account</p>
          </div>
          <LoginForm />
          <div className="mt-6 flex flex-row justify-center text-center text-sm text-zinc-400">
            <Link href="/forgot-password" className="hover:text-red-400 underline underline-offset-4">Forgot password?</Link>
          </div>
        </div>
      </div>
    </div>
