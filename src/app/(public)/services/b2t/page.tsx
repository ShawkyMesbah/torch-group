...
export default function B2TPage() {
  return (
        ...
        <div className="torch-container-wide mx-auto relative z-10">
          ...
          >
            <div className="mb-8 relative">
              ...
              <Star className="w-24 h-24 torch-text-primary relative z-10" />
            </div>
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
              Get ready for our Talents membership services! We're preparing a platform that will help your content grow with enhanced online/offline engagement and attract more audience & followers. Stay tuned for the launch.
            </p>
          </motion.div>
        </div>
      </section>
