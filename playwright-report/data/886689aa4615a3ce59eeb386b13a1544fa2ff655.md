...
- Name: Performance Tests >> should handle offline mode
- Location: C:\Users\shmes\Desktop\torch-group\e2e\performance.spec.ts:76:7
...
Call log:
  - waiting for locator('text=About')
    - locator resolved to 4 elements. Proceeding with the first one: <span class="jsx-92c024ceb42e7d09">About</span>
  ...
  - attempting click action
    ...
    at C:\Users\shmes\Desktop\torch-group\e2e\performance.spec.ts:84:16
```
...
- main:
  ...
  - heading "Welcome to Torch" [level=1]:
    ...
    - img
  - paragraph: Empowering businesses through Innovat| solutions and strategic partnerships.
