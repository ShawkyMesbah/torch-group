...
- Name: Performance Tests >> should handle slow network conditions
- Location: C:\Users\shmes\Desktop\torch-group\e2e\performance.spec.ts:42:7
...
Call log:
  ...
  - waiting for locator('[data-testid="loading-skeleton"]')
    ...
    at C:\Users\shmes\Desktop\torch-group\e2e\performance.spec.ts:50:68
```
...
- main:
  ...
  - heading "Welcome to Torch" [level=1]:
    ...
    - img
  - paragraph: Empowering businesses through Med| solutions and strategic partnerships.
