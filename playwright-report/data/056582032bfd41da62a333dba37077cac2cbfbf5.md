...
- Name: Contact Form >> should show validation errors
- Location: C:\Users\shmes\Desktop\torch-group\e2e\contact.test.ts:20:7
...
Locator: getByText(/name is required/i)
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText(/name is required/i)

    at C:\Users\shmes\Desktop\torch-group\e2e\contact.test.ts:27:55
```
